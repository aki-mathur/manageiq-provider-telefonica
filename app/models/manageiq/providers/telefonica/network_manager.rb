class ManageIQ::Providers::Telefonica::NetworkManager < ManageIQ::Providers::NetworkManager
  ...
  has_many :public_networks,  :foreign_key => :ems_id, :dependent => :destroy,
           :class_name => "ManageIQ::Providers::Telefonica::NetworkManager::CloudNetwork::Public"
  ...
  def self.ems_type
    @ems_type ||= "telefonica_network".freeze
  end
